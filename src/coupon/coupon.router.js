...
import { createCouponSchema, getUpdateDeleteCouponSchema } from "./validation.coupon.js";
...
couponRouter.put('/:id', protectedRouts, allowedTo('admin'), validation(getUpdateDeleteCouponSchema), updateCoupon);
